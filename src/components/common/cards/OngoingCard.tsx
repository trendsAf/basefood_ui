...
const OngoingCard = ({
  ...
  return (
    <div className="border p-4 md:p-5 mt-5 md:mt-10 rounded shadow-sm bg-white dark:bg-gray-800 py-10 lg:py-0 lg:h-[22rem] h-80">
      <div className="flex flex-col gap-3 md:gap-4 lg:py-4">
        ...
        <button className="mt-4 px-4 py-2 bg-[#e6e7ea] text-black hover:bg-[#d6d7da] transition">
          Submit Quote
        </button>
      </div>
    </div>
