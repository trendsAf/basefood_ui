export const insightsData = [
  {
    ...
    data: [
      ...
      "Global coffee prices expected to stabilize after a period of volatility",
      "New techniques in coffee cultivation adopted in Ethiopia",
      //   "Coffee farmers in Brazil report a 10% increase in yield this year",
    ],
  },
  {
    name: "Maize",
